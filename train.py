...
if __name__ == '__main__':
    ...
    parser_ppo_d = subparsers.add_parser('ppo_designer')
    ...
    train_ppo_designer.set_parser(parser_ppo_d)
    parser_ppo_d.set_defaults(entry=train_ppo_designer.train_designer)
